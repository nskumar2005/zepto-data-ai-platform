...
## Outputs
- `output/books.sqlite3` â€” generated normalized database.
- `output/clean_books.csv` â€” cleaned dataset.
- `output/sql_outputs.txt` â€” query strings and printed outputs.
- `output/sql_outputs.txt` â€” comparison of the SQL join result with `pd.merge` is included at the end of this file.

## Cleaning decisions
- Price is parsed into `price_gbp` as float.
- Star words Oneâ€“Five are mapped to 1â€“5.
